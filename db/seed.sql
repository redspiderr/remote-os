...
INSERT INTO standups (id, user_id, video_url, transcript, summary, status, duration, created_at) VALUES
    ...
    ('a7b8c9d0-e1f2-3456-abcd-567890123456', 'd4e5f6a7-b8c8-0123-defa-234567890123', 'https://storage.remote-os.dev/videos/asha-001.mp4', 'Working on the fleet routing algorithm. Hitting some edge cases with the pathfinding.', 'Fleet routing in progress, investigating edge cases.', 'processing', 45, NOW() - INTERVAL '5 hours'),
